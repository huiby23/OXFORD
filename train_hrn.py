...
from networks.Oxford_Radar_HRN import Oxford_Radar
from utils.monitor_1 import SVDMonitor
...
def main():
    ...
    for epoch in range(start_epoch, config['max_epochs']):
        ...
        for batchi, batch in enumerate(train_loader):
            ...
            loss, dict_loss = supervised_loss_multi_score(out['R'], out['t'], out['src'], out['tgt'], out['scores'], batch, config)
