...
class Data_Preprocess():
    ...
    def radar_img_loader(self, display_time = 10):
        """
        Function:
            - 加载radar扫描数据，并显示输出
        ...
        radar_data_dir = Path(self.dataset_dir) / 'radar'
    ...
    def road_odometry_loader(self):
        ...
        """
        gt_dir = Path(self.dataset_dir) / 'gt' / 'radar_odometry.csv'
    ...
    def run(self, train_data_dir, radar_display_time = 10):
        """
        Function:
        ...
        polar_data, cart_data, radar_timestamps = self.radar_img_loader(radar_display_time)
...
if __name__ == '__main__':
    ...
    # root_path=Path()
    data_preocesser=Data_Preprocess(Path('data/sample_large/2019-01-10-14-36-48-radar-oxford-10k-partial'))
    data_preocesser.run(Path('data/oxford_radar'))